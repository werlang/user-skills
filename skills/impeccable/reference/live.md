...
For departure variants or any event that changes aesthetic direction, load
`frontend-design` and generate variants from its creative contract. Impeccable
owns injection, project integration, parameterization, acceptance cleanup,
responsive behavior, accessibility, performance, and recovery. Identity-
preserving technical variants do not require creative delegation.
