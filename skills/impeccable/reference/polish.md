...
Impeccable owns the technical and UX shipping pass in this file. If visual
specificity, coherence, or fidelity to the approved direction is materially in
question, request one focused `frontend-design` review of the rendered result
before final technical verification. Do not use polish to invent a replacement
concept.
