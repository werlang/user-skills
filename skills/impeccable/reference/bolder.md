...
Load `frontend-design` and obtain a focused amplification contract before
choosing what becomes bolder. This playbook implements that decision within the
existing system and verifies scope, behavior, and technical quality. If an
approved contract already names the amplification, reuse it.
